...
static const flex_int16_t yy_base[16] =
    {   0,
        0,    0,   15,   16,    0,    3,    5,   10,    0,   16,
        7,    9,    0,   16,   10
    } ;

static const flex_int16_t yy_def[16] =
    {   0,
       14,    1,   14,   14,   15,   14,   14,    6,    6,   14,
       14,   11,   11,    0,   14
    } ;
...
static const flex_int16_t yy_nxt[21] =
    {   0,
       ...
       13,    7,   12,    8,   14,    3,   14,   14,   14,   14
    } ;

static const flex_int16_t yy_chk[21] =
    {   0,
        1,    1,    1,    1,    6,    6,    6,    7,    7,   11,
       11,   15,   12,    8,    3,   14,   14,   14,   14,   14
    } ;
